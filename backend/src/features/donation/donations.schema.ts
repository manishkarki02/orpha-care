...
export const getDonationsRequestSchema = z.object({
	query: z
		.object({
...
export const getDonationDetailRequestSchema = z.object({
	params: z.object({
		id: z.uuidv4("Invalid donation ID"),
	}),
});
...
export type UpdateDonationStatusRequestSchema = z.infer<typeof updateDonationStatusRequestSchema>;
export type GetDonationsRequestSchema = z.infer<typeof getDonationsRequestSchema>;
export type GetDonationDetailRequestSchema = z.infer<typeof getDonationDetailRequestSchema>;

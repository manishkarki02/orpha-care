...
// Fetch all donation
export const fetchDonations: ValidatedRequestHandler<FetchDonationsRequestSchema> = async (
	req,
	res,
) => {
...
export const fetchMyDonations: ValidatedRequestHandler<FetchDonationsRequestSchema> = async (
	req,
	res,
) => {
	const donation = await donationService.fetchMyDonations(req.query, res.locals.userId);
...
// deleting a donation
export const deleteDonation: ValidatedRequestHandler<FetchDonationDetailRequestSchema> = async (
	req,
	res,
) => {

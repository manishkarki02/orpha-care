...
export const createKid: ValidatedRequestHandler<
  CreateKidRequestSchema
> = async (req, res) => {
  const createdKid = await kidsService.createKid(
    req.body,
    res.locals.userId,
    req.file,
  );
...
export const getKids: ValidatedRequestHandler<GetKidsRequestSchema> = async (
  req,
  res,
) => {
  const { data, pagination } = await kidsService.getKids(req.query);
...
export const getAllKids: ValidatedRequestHandler<
  GetAllKidsRequestSchema
> = async (req, res) => {
  const { data, pagination } = await kidsService.getAllKids(req.query);
...
export const getKidDetails: ValidatedRequestHandler<
  GetKidDetailRequestSchema
> = async (req, res) => {
  const kidDetail = await kidsService.getKidDetailById(
    req.params.id,
    res.locals.role,
  );
...
export const updateKidDetails: ValidatedRequestHandler<
  UpdateKidDetailsRequestSchema
> = async (req, res) => {
...
export const deleteKid: ValidatedRequestHandler<
  GetKidDetailRequestSchema
> = async (req, res) => {

...
// Fetch all donation
export const fetchDonations: ValidatedRequestHandler = async (_req, res) => {
	const donation = await donationService.fetchDonations();
...
export const fetchMyDonations: ValidatedRequestHandler = async (_req, res) => {
	const donation = await donationService.fetchMyDonations(res.locals.userId);
